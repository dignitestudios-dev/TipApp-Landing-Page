  ...
  return (
    <div className="lg:px-25 py-18  ">
      ...
      >
        ...
        <p>
          {" "}
          Perks (“we,” “our,” or “us”) is committed to protecting your privacy.
          This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Perks.
        </p>
        <p>
          ...
          Perks. By accessing or using our Service, you signify that you have
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">
        ...
        <ul className="list-disc px-6 mt-4">
          ...
          <li>
            ...
            it refers to Perks LLC, 134 gorham rd Scarborough Maine that is
          ...
          <li>
            ...
            signs up to use the Perks Service to manage the relationships with
          ...
          <li>
            ...
            Perks or are under contract to perform a service on behalf of one of
            the parties.
          </li>
          <li>
        ...
        <ul className="list-disc px-6 mt-4"></ul>
        <h1 className="text-4xl mb-8 font-bold mt-4">
        ...
        <p />
        <h1 className="text-4xl mb-8 font-bold mt-4">
          When does Perks use end user information from third parties?
        </h1>
        <p>
          Perks will collect End User Data necessary to provide the Perks
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">
          When does Perks use customer information from third parties?
        </h1>
        <p>
          ...
          interest in becoming a Perks customer, we receive information from a
          third party that provides automated fraud detection services to Perks.
        ...
        <p>
          ...
          e-mail management, storage marketing, credit card processing, customer
        ...
        <p>
          ...
          website/app in a shared location, and type of the device used to visit
          the website/app. They may aggregate information about our advertising
          and what you see on the website/app and then provide auditing,
        ...
        <p>
          Perks will collect personal information that you submit to us. We may
        ...
        <p>
          We keep your information only so long as we need it to provide Perks
        ...
        <p>
          ...
          absolute security of any information you transmit to Perks or
        ...
        <p>
          Perks is incorporated in United States. Information collected via our
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">
          Is the information collected through the Perks Service secure?
        </h1>
        <p>
        ...
        <p>
          ...
          information Perks collects depend on your relationship with Perks.
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Personnel</h1>
        <p>
          If you are a Perks worker or applicant, we collect information you
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Sale of Business</h1>
        <p>
          ...
          of the assets of Perks or any of its Corporate Affiliates (as defined
          herein), or that portion of Perks or any of its Corporate Affiliates
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Affiliates</h1>
        <p>
          ...
          Perks, whether by ownership or otherwise. Any information relating to
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Governing Law</h1>
        <p>
        ...
        <p>
          By using Perks or contacting us directly, you signify your acceptance
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Your Consent</h1>
        <p>
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by Perks.
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Cookies</h1>
        <p>
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Payment Details</h1>
        <p>
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Kids' Privacy</h1>
        <p>
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Third-Party Services</h1>
        <p>
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Tracking Technologies</h1>
        <ul className="list-disc px-6 mt-4">
          <li>
            Sessions
            <br />
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">What is GDPR?</h1>
        <p>
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">What is personal data?</h1>
        <p>
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">Why is GDPR important?</h1>
        <p>
          ...
          right thing to do. At Perks we strongly believe that your data privacy
        ...
        <p>
          ...
          rights requirements of GDPR. Perks processes or stores all personal
        ...
        <h1 className="text-4xl mb-8 font-bold mt-4">California Residents</h1>
        <p>
        ...
        <p>We do not sell the Personal Information of our users.</p>
        <p>For more information about these rights, please contact us.</p>
        <h1 className="text-4xl mb-8 font-bold mt-4">Contact Us</h1>

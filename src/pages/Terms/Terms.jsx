...
export default function Terms() {
  ...
  return (
    <div className="lg:px-25 py-18  ">
      ...
      >
        <h1 className="text-4xl font-bold mb-3 mt-3">Terms &amp; Conditions</h1>
        <p>Updated at 2025-01-01</p>
        <h1 className="text-4xl font-bold mb-8 mt-7">General Terms</h1>
        <p>
          By accessing and placing an order with Perks, you confirm that you are
        ...
        <p>
          Under no circumstances shall Perks team be liable for any direct,
          ...
          inability to use, the materials on this site, even if Perks team or an
        ...
        <p>
          Perks will not be responsible for any outcome that may occur during
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">License</h1>
        <p>
          Perks grants you a revocable, non-exclusive, non-transferable, limited
          license to download, install and use the website/app strictly in
          accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms &amp; Conditions are a contract between you and Perks
          (referred to in these Terms &amp; Conditions as "Perks", "us", "we" or
          "our"), the provider of the Perks website and the services accessible
          from the Perks website (which are collectively referred to in these
          Terms &amp; Conditions as the "Perks Service").
        </p>
        <p>
          ...
          Perks Service. In these Terms &amp; Conditions, "you" refers both to
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">
        ...
        <ul className="list-disc mt-3 px-8">
          ...
          <li>
            ...
            it refers to Perks LLC, 134 gorham road, Scarborough, Maine that is
            responsible for your information under this Terms &amp; Conditions.
          </li>
          <li>
            Country: where Perks or the owners/founders of Perks are based, in
            this case is{" "}
          </li>
          <li>
            Device:&nbsp;any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Perks and use
            the services.
          </li>
          <li>
            Service: refers to the service provided by Perks as described in the
          ...
          <li>
            Website: Perks's site, which can be accessed via this URL:
            perksapp.com
          </li>
          <li>
            You: a person or entity that is registered with Perks to use the
            Services.
          </li>
        </ul>
        <h1 className="text-4xl font-bold mb-8 mt-7">Restrictions</h1>
        ...
        <ul className="list-disc mt-3 px-8">
          <li>
            ...
            website/app or make the platform available to any third party.
          </li>
          <li>
          ...
          <li>
            ...
            notice of copyright or trademark) of Perks or its affiliates,
        ...
        <p>
          Thanks for shopping at Perks. We appreciate the fact that you like to
        ...
        <p>
          ...
          apply to transactions at Perks. We’ll be as brief as our attorneys
          will allow. The main thing to remember is that by placing an order or
          making a purchase at Perks, you agree to the terms along with
          Perks's&nbsp;Privacy Policy.
        </p>
        <p>
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Your Suggestions</h1>
        <p>
          Any feedback, comments, ideas, improvements or suggestions
          (collectively, "Suggestions") provided by you to Perks with respect to
          the website/app shall remain the sole and exclusive property of Perks.
        </p>
        <p>
          Perks shall be free to use, copy, modify, publish, or redistribute the
          Suggestions for any purpose and in any way without any credit or any
          compensation to you.
        </p>
        <h1 className="text-4xl font-bold mb-8 mt-7">Your Consent</h1>
        <p>
        ...
        <p>
          ...
          Perks. We are not responsible for the content, accuracy or opinions
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Cookies</h1>
        <p>
          Perks uses "Cookies" to identify the areas of our website that you
        ...
        <p>
          You acknowledge and agree that Perks may stop (permanently or
          ...
          do not need to specifically inform Perks when you stop using the
          Service. You acknowledge and agree that if Perks disables access to
        ...
        <p>
          Perks reserves the right to modify, suspend or discontinue,
        ...
        <p>
          Perks may from time to time provide enhancements or improvements to
        ...
        <p>
          ...
          of the website/app. You agree that Perks has no obligation to (i)
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Third-Party Services</h1>
        <p>
        ...
        <p>
          You acknowledge and agree that Perks shall not be responsible for any
          ...
          or any other aspect thereof. Perks does not assume and shall not have
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Term and Termination</h1>
        <p>
          This Agreement shall remain in effect until terminated by you or
          Perks.
        </p>
        <p>
          Perks may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          Perks, in the event that you fail to comply with any provision of this
        ...
        <p>
          ...
          website/app and delete all copies of the website/app from your
          computer.
        </p>
        <p>
          Termination of this Agreement will not limit any of Perks's rights or
        ...
        <p>
          ...
          the material is not authorized by the copyright owners; and (e) the a
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Indemnification</h1>
        <p>
          You agree to indemnify and hold Perks and its parents, subsidiaries,
          ...
          website/app; (b) violation of this Agreement or any law or regulation;
          or (c) violation of any right of a third party.
        </p>
        <h1 className="text-4xl font-bold mb-8 mt-7">No Warranties</h1>
        <p>
          ...
          extent permitted under applicable law, Perks, on its own behalf and on
          ...
          website/app, including all implied warranties of merchantability,
          ...
          foregoing, Perks provides no warranty or undertaking, and makes no
          representation of any kind that the website/app will meet your
          requirements, achieve any intended results, be compatible or work with
          any other software, , systems or services, operate without
        ...
        <p>
          Without limiting the foregoing, neither Perks nor any Perks's provider
          makes any representation or warranty of any kind, express or implied:
          (i) as to the operation or availability of the website/app, or the
          information, content, and materials or products included thereon; (ii)
          that the website/app will be uninterrupted or error-free; (iii) as to
          ...
          servers, the content, or e-mails sent from or on behalf of Perks are
        ...
        <p>
          ...
          of Perks and any of its suppliers under any provision of this
        ...
        <p>
          ...
          Perks or its suppliers be liable for any special, incidental,
          ...
          inability to use the website/app, third-party software and/or
          third-party hardware used with the website/app, or otherwise in
          connection with any provision of this Agreement), even if Perks or any
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Severability</h1>
        <p>
        ...
        <p>
          ...
          notices published by Perks on the Services, shall constitute the
          entire agreement between you and Perks concerning the Services. If any
          ...
          or any other term, and Perks's failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND Perks AGREE THAT ANY CAUSE OF ACTION
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Waiver</h1>
        <p>
        ...
        <p>
          Perks reserves the right, at its sole discretion, to modify or replace
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Entire Agreement</h1>
        <p>
          The Agreement constitutes the entire agreement between you and Perks
          regarding your use of the website/app and supersedes all prior and
          contemporaneous written or oral agreements between you and Perks.
        </p>
        <p>
          You may be subject to additional terms and conditions that apply when
          you use or purchase other Perks's services, which Perks will provide
          to you at the time of such use or purchase.
        </p>
        <h1 className="text-4xl font-bold mb-8 mt-7">Updates to Our Terms</h1>
        <p>
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Intellectual Property</h1>
        <p>
          The website/app and its entire contents, features and functionality
          (including but not limited to all information, software, text,
          displays, images, video and audio, and the design, selection and
          arrangement thereof), are owned by Perks, its licensors or other
          ...
          or in part, without the express prior written permission of Perks,
          unless and except as is expressly provided in these Terms &amp;
          Conditions. Any unauthorized use of the material is prohibited.
        </p>
        <h1 className="text-4xl font-bold mb-8 mt-7">Agreement to Arbitrate</h1>
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Perks's INTELLECTUAL
          PROPERTY RIGHTS. The term “dispute” means any dispute, action, or
          other controversy between you and Perks concerning the Services or
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Notice of Dispute</h1>
        <p>
          In the event of a dispute, you or Perks must give the other a Notice
          ...
          <a
            ...
            data-cfemail="570732253c243627276567656217303a363e3b7934383a"
          >
            [email&nbsp;protected]
          </a>
          . Perks will send any Notice of Dispute to you by mail to your address
          if we have it, or otherwise to your email address. You and Perks will
          ...
          sixty (60) days, you or Perks may commence arbitration.
        </p>
        <h1 className="text-4xl font-bold mb-8 mt-7">Binding Arbitration</h1>
        <p>
          If you and Perks don’t resolve any dispute by informal negotiation,
        ...
        <p>
          ...
          and will become the sole property of Perks without any compensation or
          credit to you whatsoever. Perks and its affiliates shall have no
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Promotions</h1>
        <p>
          Perks may, from time to time, include contests, promotions,
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Typographical Errors</h1>
        <p>
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Miscellaneous</h1>
        <p>
          ...
          signed by an authorized representative of Perks. Perks will be
          ...
          or anticipatory breach by you. Perks operates and controls the Perks
          Service from its offices in . The Service is not intended for
          distribution to or use by any person or entity in any jurisdiction or
          country where such distribution or use would be contrary to law or
          regulation. Accordingly, those persons who choose to access the Perks
          ...
          include and incorporate the Perks Privacy Policy) contains the entire
          understanding, and supersedes all prior understandings, between you
          and Perks concerning its subject matter, and cannot be changed or
        ...
        <h1 className="text-4xl font-bold mb-8 mt-7">Disclaimer</h1>
        <p>
          Perks is not responsible for any content, code or any other
          imprecision.
        </p>
        <p>Perks does not provide warranties or guarantees.</p>
        <p>
          In no event shall Perks be liable for any special, direct, indirect,
        ...
        <p>
          The Perks Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. Perks is a distributor and not a publisher
          of the content supplied by third parties; as such, Perks exercises no
          ...
          accessible via the Perks Service. Without limiting the foregoing,
          Perks specifically disclaims all warranties and representations in any
          content transmitted on or in connection with the Perks Service or on
          sites that may appear as links on the Perks Service, or in the
          products provided as a part of, or otherwise in connection with, the
          Perks Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          Perks or any of its affiliates, employees, officers, directors,
          ...
          foregoing, Perks does not warrant that the Perks Service will be
          uninterrupted, uncorrupted, timely, or error-free.
        </p>
        <h1 className="text-4xl font-bold mb-8 mt-7">Contact Us</h1>
        ...
        <ul className="list-disc mt-3 px-8">
          <li>
            ...
            <a
              href="/cdn-cgi/l/email-protection"
              className="__cf_email__"
              data-cfemail="eebe8b9c859d8f9e9edcdedcdbae89838f8782c08d8183"
            >
              [email&nbsp;protected]
            </a>
          </li>

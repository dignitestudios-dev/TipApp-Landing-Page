...
const formData = new FormData();
    ...
    formData.append("method", "venmo"); // Or 'venmo' depending on the method
    ...
    try {
      ...
      ErrorToast('Error processing Venmo donation.');
      console.error(error);
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="mt-20 px-4">
        ...
        {userData?.venmo ? (
          ...
          <button
            ...
            className="w-full bg-slate-400 text-white font-semibold py-2 rounded-xl mt-6 flex justify-center items-center"
